...
opt.background = "dark"                          -- default to dark or light style
...
opt.showtabline = 1                              -- always show tabs 2
...
opt.foldmethod = "expr"                          -- sets fold method to a custom expression
opt.foldexpr = "v:lua.vim.treesitter.foldexpr()" -- uses treesitter as the fold expression
opt.foldcolumn = "0"                             -- hide fold column
opt.foldtext = ""                                -- syntax highlight first line of folds
opt.foldlevel = 99                               -- sets the minimum level of a fold that will be closed by default
