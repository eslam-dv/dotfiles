...
# Brightness
brightness=$(brightnessctl -m intel_backlight g | awk -F, '{print $4}' | tr -d %)
...
echo "⌨  $language | $audio_active $audio_volume% | ☼ $brightness | $battery_pluggedin $battery_charge | $date 🕑 $current_time"
